...
CBaseMultiplayerPlayer.GetNetworkIDString <- function()
...
{   // Returns true if the player is in the bomb trigger area.
    return NetProps.GetPropBool(this, "m_bInBombZone");
}
...
{   // Slays a player. By default, the attacker is the world. Setting to null, the attacker is the this.
...
CBaseMultiplayerPlayer.ForceSecondaryAttack <- function() // Does this have any use in CSS?
